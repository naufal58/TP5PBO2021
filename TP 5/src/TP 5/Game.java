...
public class Game extends Canvas implements Runnable{
    ...
    public int acak(int awal, int akhir) {
        return (int) ((Math.random() * (500 - 50)) + 50);
    }
    
    public Game(){
        window = new Window(WIDTH, HEIGHT, "TP 5", this);
        ...
        if(gameState == STATE.Game){
            handler.addObject(new Items(200,150, ID.Item));
    ...
    public void run() {
        ...
        while(running){
            ...
            if(System.currentTimeMillis() - timer > 1000){
                ...
                frames = 0;
                if(gameState == STATE.Game){
                   //System.out.println(handler.countObject());
                    if(handler.countObject() == 1){
                        //System.out.println("Generating..");
                        Random rand = new Random();
                        int[] randNum = {0,0,0,0,0,0};
                        for(int i = 0; i < 6; i++){
                            randNum[i] = rand.nextInt(600);
                        }
                    ...
                    if(time>0){
                        ...
                        System.out.println(username + " | " + String.valueOf(score));
                        dbcon.uploadScore(username, score);
                    }
                }
